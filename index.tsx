...
export default definePlugin({
    name: "Ghosted (Blu-Fork)",
    description: "A cute ghost will appear if you don't answer their DMs (Clyde messages don't count)",
    authors: [EquicordDevs.vei, Devs.sadan, EquicordDevs.justjxke, { name: "Bluscream", id: 467777925790564352n }, { name: "Cursor.AI", id: 0n }],
    settings,
